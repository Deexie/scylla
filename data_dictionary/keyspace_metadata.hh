...
public:
    ...
    const locator::replication_strategy_config_options* previous_strategy_options_opt() const {
        return _previous_strategy_options.has_value() ? &_previous_strategy_options.value() : nullptr;
    }
    const locator::replication_strategy_config_options& strategy_options() const {
        return _strategy_options;
    }
    const locator::replication_strategy_config_options* next_strategy_options_opt() const {
        return _next_strategy_options.has_value() ? &_next_strategy_options.value() : nullptr;
    }
